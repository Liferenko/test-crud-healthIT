...
var i_33072 = (0);
while(true){
if((i_33072 < arr.length)){
(arr[i_33072] = null);

var G__33074 = (i_33072 + (1));
i_33072 = G__33074;
continue;
} else {
}
...
var i_33097 = (self__.level + (1));
while(true){
if((i_33097 <= (new_level + (1)))){
(update[i_33097] = self__.header);

var G__33098 = (i_33097 + (1));
i_33097 = G__33098;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33100 = (update[i]).forward;
(x__$2.forward[i] = (links_33100[i]));
...
var i_33106 = (0);
while(true){
if((i_33106 <= self__.level)){
var links_33107 = (update[i_33106]).forward;
if((x__$1 === (((i_33106 < links_33107.length))?(links_33107[i_33106]):null))){
(links_33107[i_33106] = (x__$1.forward[i_33106]));

var G__33110 = (i_33106 + (1));
i_33106 = G__33110;
continue;
} else {
var G__33111 = (i_33106 + (1));
i_33106 = G__33111;
continue;
}
} else {
