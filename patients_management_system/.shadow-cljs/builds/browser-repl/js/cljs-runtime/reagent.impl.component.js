...
if((i < len)){
var k = (ks[i]);
var G__28063 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__28064 = (i + (1));
m = G__28063;
i = G__28064;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27944 = c;
var G__27944__$1 = (((G__27944 == null))?null:G__27944.prototype);
if((G__27944__$1 == null)){
return null;
} else {
return G__27944__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27948 = c;
var G__27948__$1 = (((G__27948 == null))?null:G__27948.prototype);
if((G__27948__$1 == null)){
return null;
} else {
return G__27948__$1.render;
}
})() == null)))));
});
...
var G__27963 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__27963) : reagent.impl.component.as_element.call(null,G__27963));
};
...
while (G__28085__i < G__28085__a.length) {G__28085__a[G__28085__i] = arguments[G__28085__i + 0]; ++G__28085__i;}
  args = new cljs.core.IndexedSeq(G__28085__a,0,null);
} 
...
var G__27964 = c;
var G__27964__$1 = (((G__27964 == null))?null:G__27964.constructor);
if((G__27964__$1 == null)){
return null;
} else {
return G__27964__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__27966 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27967 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27967);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27966);
}});
...
var c = this;
var G__27980_28093 = goog.object.get(c,"cljsRatom");
if((G__27980_28093 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27980_28093);
}
...
var renders_28095 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_28096 = cljs.core.first(cljs.core.vals(renders_28095));
...
if((cljs.core.count(renders_28095) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_28095))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28096)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28096], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__28025 = o;
goog.object.set(G__28025,cljs.core.name(k),v);
