...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_27555 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_27555(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_27558 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_27558(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_27562 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_27562(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_27563 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_27563(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_27564 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_27564(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_27565 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_27565(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_27566 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_27566(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_27567 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_27567(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_27568 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_27568(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_27574 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_27574(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k27542,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k27542,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__27547){
var vec__27548 = p__27547;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27548,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27548,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27541){
var self__ = this;
var G__27541__$1 = this;
return (new cljs.core.RecordIter((0),G__27541__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27543,other27544){
var self__ = this;
var this27543__$1 = this;
return (((!((other27544 == null)))) && ((this27543__$1.constructor === other27544.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.status,other27544.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.body,other27544.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.status_text,other27544.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.headers,other27544.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.was_aborted,other27544.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27543__$1.__extmap,other27544.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__27541){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__27551 = cljs.core.keyword_identical_QMARK_;
var expr__27552 = k__4388__auto__;
if(cljs.core.truth_((pred__27551.cljs$core$IFn$_invoke$arity$2 ? pred__27551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__27552) : pred__27551.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__27552)))){
return (new ajax.protocols.Response(G__27541,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27551.cljs$core$IFn$_invoke$arity$2 ? pred__27551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__27552) : pred__27551.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__27552)))){
return (new ajax.protocols.Response(self__.status,G__27541,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27551.cljs$core$IFn$_invoke$arity$2 ? pred__27551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__27552) : pred__27551.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__27552)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__27541,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27551.cljs$core$IFn$_invoke$arity$2 ? pred__27551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__27552) : pred__27551.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__27552)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__27541,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27551.cljs$core$IFn$_invoke$arity$2 ? pred__27551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__27552) : pred__27551.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__27552)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__27541,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__27541),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__27541){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__27541,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__27545){
var extmap__4419__auto__ = (function (){var G__27554 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27545,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__27545),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__27545),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__27545),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__27545),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__27545),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
