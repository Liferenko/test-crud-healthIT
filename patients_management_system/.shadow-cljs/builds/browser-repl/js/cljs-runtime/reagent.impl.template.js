...
var G__28088 = o;
goog.object.set(G__28088,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__28223__delegate = function (args){
...
while (G__28224__i < G__28224__a.length) {G__28224__a[G__28224__i] = arguments[G__28224__i + 0]; ++G__28224__i;}
  args = new cljs.core.IndexedSeq(G__28224__a,0,null);
} 
return G__28223__delegate.call(this,args);};
G__28223.cljs$lang$maxFixedArity = 0;
G__28223.cljs$lang$applyTo = (function (arglist__28225){
var args = cljs.core.seq(arglist__28225);
return G__28223__delegate(args);
});
...
var G__28094 = o;
goog.object.set(G__28094,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__28227__i < G__28227__a.length) {G__28227__a[G__28227__i] = arguments[G__28227__i + 0]; ++G__28227__i;}
  args = new cljs.core.IndexedSeq(G__28227__a,0,null);
} 
...
var G__28097 = props;
var G__28097__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28097,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28097);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28097__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__28097__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28100 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28100,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28100;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28104){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28105__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__28111_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__28111_SHARP_);
}));
} else {
return null;
}
...
var vec__28125 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28125,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28125,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28125,(2),null);
...
var temp__5739__auto___28275 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___28275 == null)){
} else {
var key_28276 = temp__5739__auto___28275;
(jsprops.key = key_28276);
}
...
var temp__5739__auto___28281 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___28281 == null)){
} else {
var key_28282 = temp__5739__auto___28281;
(jsprops.key = key_28282);
}
...
var G__28140 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28140) : reagent.impl.template.as_element.call(null,G__28140));
} else {
var temp__5739__auto___28291 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___28291 == null)){
} else {
var key_28292 = temp__5739__auto___28291;
(jsprops.key = key_28292);
}
...
var G__28150 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__28150)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__28150)){
return x;
} else {
...
var len__4736__auto___28295 = arguments.length;
var i__4737__auto___28296 = (0);
while(true){
if((i__4737__auto___28296 < len__4736__auto___28295)){
args__4742__auto__.push((arguments[i__4737__auto___28296]));

var G__28297 = (i__4737__auto___28296 + (1));
i__4737__auto___28296 = G__28297;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28152){
var G__28153 = cljs.core.first(seq28152);
var seq28152__$1 = cljs.core.next(seq28152);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28153,seq28152__$1);
}));
...
break;
default:
var G__28301 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__28301;
continue;
...
var ctx = ({});
var vec__28181 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28181,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28181,(1),null);
...
var G__28185 = (cljs.core.count(argv) - first_child);
switch (G__28185) {
case (0):
