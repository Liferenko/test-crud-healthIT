...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__28118 = cljs.core.second(format);
var G__28119 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__28118,G__28119) : ajax.easy.keyword_response_format_element.call(null,G__28118,G__28119));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__28123 = format;
var G__28123__$1 = (((G__28123 instanceof cljs.core.Keyword))?G__28123.fqn:null);
switch (G__28123__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28124_SHARP_){
return ajax.easy.keyword_response_format_element(p1__28124_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__28132){
var map__28133 = p__28132;
var map__28133__$1 = (((((!((map__28133 == null))))?(((((map__28133.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28133.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28133):map__28133);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28133__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28133__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28133__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__28141){
var vec__28142 = p__28141;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28142,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28142,(1),null);
var fexpr__28146_28184 = (cljs.core.truth_(ok)?h:e);
(fexpr__28146_28184.cljs$core$IFn$_invoke$arity$1 ? fexpr__28146_28184.cljs$core$IFn$_invoke$arity$1(result) : fexpr__28146_28184.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__28151){
var map__28154 = p__28151;
var map__28154__$1 = (((((!((map__28154 == null))))?(((((map__28154.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28154.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28154):map__28154);
var opts = map__28154__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28154__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28154__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28154__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28154__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28154__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
