...
var G__28422 = devtools.prefs.pref(v);
v = G__28422;
continue;
} else {
return v;
...
}catch (e28387){var _e__27682__auto__ = e28387;
return false;
}})();
...
}catch (e28393){var _e__27682__auto__ = e28393;
return false;
}})();
...
}catch (e28395){var _e__27682__auto__ = e28395;
return false;
}}
}
});
...
var vec__28405 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28405,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28405,(1),null);
...
return cljs.core.some((function (p1__28410_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28410_SHARP_);
}),template);
});
