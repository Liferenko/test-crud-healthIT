...
var G__26964 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26964;
continue;
} else {
return ch;
...
var vec__26869 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26869,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26892){
...
return (function() { 
var G__27019__delegate = function (rdr,_){
...
var G__27019 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27020__i = 0, G__27020__a = new Array(arguments.length -  1);
while (G__27020__i < G__27020__a.length) {G__27020__a[G__27020__i] = arguments[G__27020__i + 1]; ++G__27020__i;}
  _ = new cljs.core.IndexedSeq(G__27020__a,0,null);
} 
return G__27019__delegate.call(this,rdr,_);};
G__27019.cljs$lang$maxFixedArity = 1;
G__27019.cljs$lang$applyTo = (function (arglist__27022){
var rdr = cljs.core.first(arglist__27022);
var _ = cljs.core.rest(arglist__27022);
return G__27019__delegate(rdr,_);
});
