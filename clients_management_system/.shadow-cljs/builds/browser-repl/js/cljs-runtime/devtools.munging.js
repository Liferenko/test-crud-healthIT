...
var o28182 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28182["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28183 = temp__5733__auto____$1;
return (o28183["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27664__auto__ = f;
return (o__27664__auto__["toString"]).call(o__27664__auto__);
} else {
return "";
}
}catch (e28185){var _ = e28185;
return "";
}});
...
try{var o__27664__auto___28373 = t;
(o__27664__auto___28373["cljs$lang$ctorPrWriter"]).call(o__27664__auto___28373,t,writer);
}catch (e28191){var __28374 = e28191;
}
...
var char_code = (function (){var o__27664__auto__ = (new String(char$));
return (o__27664__auto__["charCodeAt"]).call(o__27664__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27664__auto__ = String;
return (o__27664__auto__["fromCharCode"]).call(o__27664__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28199 = num_code;
switch (G__28199) {
case (1):
return (185);
...
var o__27664__auto__ = String;
return (o__27664__auto__["fromCharCode"]).call(o__27664__auto__,superscript_code);
});
/**
...
}catch (e28215){var _e__27682__auto__ = e28215;
return false;
}})())){
...
var vec__28217 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28217,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28230 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28230["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28232 = temp__5733__auto____$1;
return (o28232["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28238){
var vec__28239 = p__28238;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28239,(0),null);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28235){
...
var vec__28257 = cljs.core.split_with((function (p1__28251_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28251_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28257,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28257,(1),null);
...
var vec__28264 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28264,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28264,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28398 = cljs.core.rest(remaining_tokens);
var G__28399 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28398;
name_tokens = G__28399;
continue;
} else {
...
var vec__28272 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28272,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28272,(1),null);
var vec__28275 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28275,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28275,(1),null);
var vec__28278 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(3),null);
...
var vec__28289 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28292 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28292,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28292,(1),null);
var vec__28295 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28295,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28295,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28301 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28301) : devtools.munging.parse_fn_info_deep.call(null,G__28301));
})()));
}
} else {
return fn_info;
...
var G__28408 = (arity + (1));
var G__28409 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28312){
var vec__28313 = p__28312;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28313,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28313,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28322_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28322_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28323_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28323_SHARP_);
}),sorted_infos);
...
var G__28418 = (i__4737__auto___28416 + (1));
i__4737__auto___28416 = G__28418;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28326){
var vec__28327 = p__28326;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28327,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28324){
var G__28325 = cljs.core.first(seq28324);
var seq28324__$1 = cljs.core.next(seq28324);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28325,seq28324__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28338__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28338__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28338__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28338__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28339 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28339,(5),null);
...
var o__27664__auto__ = f;
return (o__27664__auto__["getBasis"]).call(o__27664__auto__);
});
/**
...
}catch (e28345){var _e__27682__auto__ = e28345;
...
var G__28461 = (obj[cljs.core.first(path)]);
var G__28462 = cljs.core.rest(path);
obj = G__28461;
path = G__28462;
continue;
} else {
...
var _STAR_ = (function (accum,p__28356){
var vec__28357 = p__28356;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28357,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28357,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28360){
var vec__28361 = p__28360;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28361,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28361,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28361,(2),null);
...
var post_process = (function (p__28369){
var vec__28370 = p__28369;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28370,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28370,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28368_SHARP_){
return (obj[cljs.core.first(p1__28368_SHARP_)]);
}),sorted_matches);
