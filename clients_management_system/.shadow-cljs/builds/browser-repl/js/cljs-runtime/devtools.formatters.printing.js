...
var G__28536 = (i__4737__auto___28533 + (1));
i__4737__auto___28533 = G__28536;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28452){
var G__28453 = cljs.core.first(seq28452);
var seq28452__$1 = cljs.core.next(seq28452);
var G__28454 = cljs.core.first(seq28452__$1);
var seq28452__$2 = cljs.core.next(seq28452__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28453,G__28454,seq28452__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28482_SHARP_){
return (!((cljs.core.meta(p1__28482_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28507__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28515){var _e__27682__auto__ = e28515;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28517){var _e__27682__auto__ = e28517;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28520 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28521 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28521);

try{var map__28523 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28523__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28520);
}});
...
var temp__5733__auto___28556 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___28556)){
var managed_print_level_28557 = temp__5733__auto___28556;
var _STAR_print_level_STAR__orig_val__28527_28558 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28528_28559 = managed_print_level_28557;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28528_28559);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28526_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28526_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28527_28558);
}} else {
job_fn();
}
